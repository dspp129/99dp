...
const reviewButton = (vm, h, currentRowData) =>{
    return h('Button', {
        ...
        on: {
            click: () => {
                const attachmentTypeName = vm.attachmentTypeMap.get(currentRowData.attachmentType)
        ...
        init () {
            ...
            this.columnList.forEach(item => {
                ...
                if (item.key === 'attachmentType') {
                    item.render = (h, param) => {
                        const currentRowData = this.reportList[param.index]
                        return h('span', this.attachmentTypeMap.get(currentRowData.attachmentType))
                    };
                }
